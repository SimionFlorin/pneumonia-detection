...
const boxes = [
    { text: 'Single Model Predict', icon: <MdOnlinePrediction style={{ fontSize: 50 }} /> },
    { text: 'Single Tabular Model Predict', icon: <MdTableRows style={{ fontSize: 50 }} /> },
    { text: 'Multi-Model Predict', icon: <MdBatchPrediction style={{ fontSize: 50 }} /> },
    { text: 'Tabular Multi-Model Predict', icon: <MdBackupTable style={{ fontSize: 50 }} /> },
  ];
